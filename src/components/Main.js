...
import { faTicket, faMagnifyingGlass,faCircleUp, faRotate } from "@fortawesome/free-solid-svg-icons";
import MovieSlider from "./MovieSlider";
import "../App.css";
import { useRef, useState } from "react";
import { keyframes } from "styled-components";
import { action, adventure,comedy,crime,horror,thriller,sf,drama,fantasy,mystery,war,family } from "./scrollfunc";
        ...
        <Container>
          ...
          <Nav>
            <NavDropdown
              ...
              title="영화"
              menuVariant="dark"
              style={{paddingLeft:"10px", fontSize:"20px", marginTop:"20px"}}
            >
              ...
              <NavDropdown.Item onClick={war}>전쟁</NavDropdown.Item>
                ...
                <FontAwesomeIcon icon={faTicket} href="https://www.cgv.co.kr/"
                target={"_blank"}
                style={navStyle}/>
